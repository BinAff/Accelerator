...
namespace Crystal.Lodge.Component.Room.Status
{
    public class Dao : BinAff.Core.Dao
    {
        ...
        { // insert will be done manually using script
            base.CreateStoredProcedure = "RoomStatusInsert";
            base.NumberOfRowsAffectedInCreate = 1;
            base.ReadStoredProcedure = "[Lodge].[RoomStatusRead]";
            base.UpdateStoredProcedure = "RoomStatusUpdate";
            base.NumberOfRowsAffectedInUpdate = -1;
            base.DeleteStoredProcedure = "[Lodge].[RoomStatusDelete]";
