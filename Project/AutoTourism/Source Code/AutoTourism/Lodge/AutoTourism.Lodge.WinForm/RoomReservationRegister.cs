...
namespace AutoTourism.Lodge.WinForm
{
    ...
    public partial class RoomReservationRegister : Form
    {
        ...
        //public RoomReservationRegister(AutoTourism.Facade.Rule.Dto ruleDto)
        //{
        //    InitializeComponent();
        ...
        //    ReturnObject<RoomReservationRegisterFormDto> ret = reservation.LoadRegisterForm(Convert.ToInt64(LodgeReservationStatus.Open), dtBookingFrom.Value, dtBookingTo.Value);
        ...
        //private void PopulateReservationData(List<RoomReservationRegisterDto> RoomRegistrationRegisterList)
        //{
        ...
        //private void PopulateReservationDetails(RoomReservationRegisterDto dto)
        //{
        ...
        //        AutoTourism.Facade.LodgeManagement.CheckIn.Dto checkInDto = dto == null ? null : new Facade.LodgeManagement.CheckIn.Dto()
        //        {
        //            Reservation = new Dto
        //            {
        //                Id = dto.Id,
        ...
        //        new CheckInForm(checkInDto, this.ruleDto)
        //        {
        ...
        //private void OpenForm(RoomReservationRegisterDto dto)
        //{
        //    if (dgvReservation.DataSource != null)
        //    {
