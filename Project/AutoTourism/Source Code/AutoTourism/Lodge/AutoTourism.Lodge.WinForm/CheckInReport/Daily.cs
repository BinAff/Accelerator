...
namespace AutoTourism.Lodge.WinForm.CheckInReport
{
    ...
    {
        private Facade.CheckInReport.Dto dto;
        private Facade.CheckInReport.FormDto formDto;
        ...
        public Daily(Facade.CheckInReport.Dto dto)
        {
            InitializeComponent();
            ...
            this.dto = dto;
            this.formDto = new Facade.CheckInReport.FormDto { dto = this.dto };
        ...
        private void LoadData(DateTime date)
        {
            ...
            //List<Facade.Dto> customerDataList = report.GetDailyReport(date);
        ...
        {
            Facade.CheckInReport.Dto dto = this.dto as Facade.CheckInReport.Dto;           
            dto.date = dpSearchDate.Value.Date;
            dto.category = new Vanilla.Utility.Facade.Report.Category.Dto { Id = Convert.ToInt64(ReportCategory.Daily) };

            BinAff.Facade.Library.Server facade = new Facade.CheckInReport.Server(this.formDto);
            facade.Add();
