...
namespace Crystal.Diary.Component.Appointment.Type
{
    ...
    public class Dao : BinAff.Core.Dao
    {
        ...
        {
            base.CreateStoredProcedure = "Utility.AppointmentTypeInsert";
            base.NumberOfRowsAffectedInCreate = 1;
            base.ReadStoredProcedure = "Utility.AppointmentTypeRead";
            base.ReadAllStoredProcedure = "Utility.AppointmentTypeReadAll";
            base.UpdateStoredProcedure = "Utility.AppointmentTypeUpdate";
            base.NumberOfRowsAffectedInUpdate = -1;
            base.DeleteStoredProcedure = "Utility.AppointmentTypeDelete";
        ...
        internal Boolean ReadDuplicate()
        {
            ...
            this.CreateCommand("Utility.AppointmentTypeReadDuplicate");
