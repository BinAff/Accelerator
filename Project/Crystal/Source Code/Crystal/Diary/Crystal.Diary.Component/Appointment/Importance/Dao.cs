...
namespace Crystal.Diary.Component.Appointment.Importance
{
    ...
    public class Dao : BinAff.Core.Dao
    {
        ...
        {
            base.CreateStoredProcedure = "Utility.ImportanceInsert";
            base.NumberOfRowsAffectedInCreate = 1;
            base.ReadStoredProcedure = "Utility.ImportanceRead";
            base.ReadAllStoredProcedure = "Utility.ImportanceReadAll";
            base.UpdateStoredProcedure = "Utility.ImportanceUpdate";
            base.NumberOfRowsAffectedInUpdate = -1;
            base.DeleteStoredProcedure = "Utility.ImportanceDelete";
        ...
        internal Boolean ReadDuplicate()
        {
            ...
            this.CreateCommand("Utility.ImportanceReadDuplicate");
