...
namespace Crystal.Lodge.Component.RoomReservationReport.Navigator.Artifact
{
    public class Dao : CrystalNavigator.Artifact.Dao
    {
        ...
        {
            base.Compose();
            this.DeleteArtifactLinkSPName = "[Lodge].[DeleteRoomReservationReportForArtifact]";
        }

        protected override Boolean ReadBefore()
        {
            base.CreateConnection();
            base.CreateCommand("[Lodge].[ReadRoomReservationReportForArtifact]");
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (reportId > 0)
                {
                    (this.Data as Data).ModuleData = new Customer.Component.Report.Data
                    {
                        Id = reportId
                    };
                }
        ...
        protected override Boolean CreateAfterModuleArtifactLink()
        {
            ...
            base.CreateCommand("[Lodge].[InsertRoomReservationReportForArtifact]");
            ...
            {
                base.AddInParameter("@ReportId", DbType.Int64, artifactData.ModuleData.Id);
            }
