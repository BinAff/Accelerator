...
namespace Crystal.Lodge.Component.RoomReservationReport
{
    public class Server : Crystal.Report.Component.Server
    {
        ...
        {
            return ((Dao)this.DataAccess).GetRoomReservationData(date, date);
        }
        ...
        public override List<BinAff.Core.Data> GetWeeklyReport(System.DateTime date)
        {
            ...
            return ((Dao)this.DataAccess).GetRoomReservationData(firstDayOfWeek, lastDayOfWeek);
        }
        ...
        public override List<BinAff.Core.Data> GetMonthlyReport(System.DateTime date)
        {
            ...
            return ((Dao)this.DataAccess).GetRoomReservationData(firstDayOfMonth, lastDayOfMonth);
        }
        ...
        {          
            ...
            return ((Dao)this.DataAccess).GetRoomReservationData(firstDayOfQuarter, lastDayOfQuarter);
        }
        ...
        public override List<BinAff.Core.Data> GetYearlyReport(System.DateTime date)
        {
            ...
            return ((Dao)this.DataAccess).GetRoomReservationData(firstDayOfYear, lastDayOfYear);
        }
