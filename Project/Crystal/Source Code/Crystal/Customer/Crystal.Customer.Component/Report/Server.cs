...
namespace Crystal.Customer.Component.Report
{
    public class Server : Crystal.Report.Component.Server
    {
        ...
        {
            return ((Dao)this.DataAccess).GetCustomerData(date, date);
        }
        ...
        public override List<BinAff.Core.Data> GetWeeklyReport(System.DateTime date)
        {
            ...
            return ((Dao)this.DataAccess).GetCustomerData(firstDayOfWeek, lastDayOfWeek);
        }
        ...
        public override List<BinAff.Core.Data> GetMonthlyReport(System.DateTime date)
        {
            ...
            return ((Dao)this.DataAccess).GetCustomerData(firstDayOfMonth, lastDayOfMonth);
        }
        ...
        {          
            ...
            return ((Dao)this.DataAccess).GetCustomerData(firstDayOfQuarter, lastDayOfQuarter);
        }
        ...
        public override List<BinAff.Core.Data> GetYearlyReport(System.DateTime date)
        {
            ...
            return ((Dao)this.DataAccess).GetCustomerData(firstDayOfYear, lastDayOfYear);
        }
