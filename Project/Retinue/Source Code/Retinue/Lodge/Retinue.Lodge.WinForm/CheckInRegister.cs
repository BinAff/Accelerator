...
namespace Retinue.Lodge.WinForm
{
    ...
    public partial class CheckInRegister : Form
    {
        ...
        //{
        //    Retinue.Facade.LodgeManagement.CheckIn.Dto checkInDto = new Dto()
        //    {
        //        Reservation = new Retinue.Facade.LodgeManagement.Reservation.Dto()
        //        {
        //            Id = dto.Reservation.Id,
        ...
        //{
        //    Boolean blnAdd = true;
        //    Retinue.Facade.LodgeManagement.Invoice.FormDto formDto = new Facade.LodgeManagement.Invoice.FormDto();
        ...
        //    {
        //        foreach (Retinue.Facade.Configuration.Room.Dto dtoRoom in dto.Reservation.RoomList)
        //        {
        //            Retinue.Facade.LodgeManagement.Invoice.Dto dtoInvoice = new Facade.LodgeManagement.Invoice.Dto()
        //            {
        ...
        //            {
        //                blnAdd = true;
        //                foreach (Retinue.Facade.LodgeManagement.Invoice.Dto invoiceDto in formDto.invoiceList)
        //                {
