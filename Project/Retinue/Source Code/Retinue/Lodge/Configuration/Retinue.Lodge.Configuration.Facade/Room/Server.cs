...
using CrysComp = Retinue.Lodge.Component.Room;
using BuildingCrys = Retinue.Lodge.Component.Building;
using LodgeObserver = Retinue.Lodge.Observer;
...
namespace Retinue.Lodge.Configuration.Facade.Room
{
    ...
    public class Server : BinAff.Facade.Library.Server, IRoom
    {
        ...
        private ReturnObject<Boolean> Close(BuildingFac.ReasonDto dto)
        {
            ...
            CrysComp.Data data = new Retinue.Lodge.Component.Room.Data
            {
                Id = dto.Id, //room id
