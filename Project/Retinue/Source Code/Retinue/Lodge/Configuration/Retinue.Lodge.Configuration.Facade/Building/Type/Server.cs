...
using CrysComp = Crystal.Organization.Component.Unit.Type;
using ObsCrys = Crystal.Organization.Observer;

namespace Retinue.Lodge.Configuration.Facade.Building.Type
{
    ...
    public class Server : BinAff.Facade.Library.Server
    {
        ...
        public override void Delete()
        {
            ...
            (new ObsCrys.UnitType() as IRegistrar).Register(crud); //Register Observers
