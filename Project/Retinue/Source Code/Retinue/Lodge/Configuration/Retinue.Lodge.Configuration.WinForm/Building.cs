...
using BuildingFac = Retinue.Lodge.Configuration.Facade.Building;
...
namespace Retinue.Lodge.Configuration.WinForm
{
    ...
    public partial class Building : Form
    {
        ...
        //private Retinue.Facade.UserManagement.User.Dto userDto = null;

        //public Building(Retinue.Facade.UserManagement.User.Dto userDto)
        //{
        //    InitializeComponent();
        ...
        {
            this.formDto.Dto = new BuildingFac.Dto();
            this.CreateDto();
            ...
            else
            {
                ...
                BinAff.Facade.Library.Server building = new BuildingFac.Server(this.formDto);
                building.Add();
                new PresLib.MessageBox
                {
                    DialogueType = building.IsError ? PresLib.MessageBox.Type.Error : PresLib.MessageBox.Type.Information,
                    Heading = "Splash",
        ...
        private void CreateDto()
        {
            ...
            this.formDto.Dto.Type = (BuildingFac.Type.Dto)this.cboType.SelectedItem;
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
                ...
                System.Windows.Forms.MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                this.formDto.Dto = new BuildingFac.Dto
                {
                    Id = ((BuildingFac.Dto)this.cboBuildingList.SelectedItem).Id
                };
                building.Delete();
        ...
        private void cboBuildingList_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.cboBuildingList.SelectedIndex != -1)
            {
                this.formDto.Dto = this.formDto.DtoList.FindLast((p) => p == this.cboBuildingList.SelectedItem as BuildingFac.Dto);
                ...
                {
                    if (this.formDto.Dto.Type.Id == ((BuildingFac.Type.Dto)cboType.Items[i]).Id)
                    {
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            if ((this.cboBuildingList.SelectedItem as BuildingFac.Dto).Status.Id == Convert.ToInt64(BuildingStatus.Close))
            {
                new PresLib.MessageBox
                {
                    DialogueType = PresLib.MessageBox.Type.Error,
        ...
        private void btnOpen_Click(object sender, EventArgs e)
        {
            ...
            this.formDto.Dto = (BuildingFac.Dto)this.cboBuildingList.SelectedItem;
            ...
            BuildingFac.IBuilding building = new BuildingFac.Server(this.formDto);
            building.Open();
            new PresLib.MessageBox
            {
                DialogueType = PresLib.MessageBox.Type.Alert,
                Heading = "Splash",
            }.Show((building as BuildingFac.Server).DisplayMessageList);
        ...
        {
            this.formDto = new BuildingFac.FormDto
            {
                Dto = new BuildingFac.Dto
                {
                    FloorList = new List<Table>(),
                },
                DtoList = new List<BuildingFac.Dto>(),
                TypeList = new List<BuildingFac.Type.Dto>(),
            };
            BinAff.Facade.Library.Server facade = new BuildingFac.Server(this.formDto);
            facade.LoadForm();
        ...
        {
            BuildingFac.Dto dto = this.formDto.DtoList.FindLast((p) => String.Compare(p.Name, txtName.Text.Trim(), true) == 0 && p.Id != this.formDto.Dto.Id);
            return (dto != null);
        }

        //private Boolean OverWriteDefaultIfExists(BuildingFac.Dto data)
        //{
        //    if (chkDefault.Checked)
        //    {
        //        List<BuildingFac.Dto> list = (List<BuildingFac.Dto>)this.cboBuildingList.DataSource;
        //        foreach (BuildingFac.Dto dto in list)
        //        {
