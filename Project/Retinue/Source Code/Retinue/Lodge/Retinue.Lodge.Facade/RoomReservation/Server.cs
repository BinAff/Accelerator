...
using RoomRsvArtf = Retinue.Lodge.Component.Room.Reservation.Navigator.Artifact;
...
namespace Retinue.Lodge.Facade.RoomReservation
{
    ...
    public class Server : FrmFac.Server
    {
        ...
        {
            return "Retinue.Lodge.Component.Room.Reservation.Navigator.Artifact.Data, Retinue.Lodge.Component";
        }
        ...
        {
            return new Retinue.Lodge.Observer.RoomReservation();
        }
        ...
        {
            int retVal = 0;
            Crystal.Customer.Component.Action.IAction reservation = new Retinue.Lodge.Component.Room.Reservation.Server(null);
        ...
        private Int32 GetTotalNoBookedRooms(Dto dto)
        {
            ...
            CustCrys.Action.IAction reservation = new Retinue.Lodge.Component.Room.Reservation.Server(null);
        ...
        //    //Retinue.Lodge.Reservation.IReservation reservation = new Server(new Retinue.Lodge.Reservation.Data
        //    //{
