...
namespace Retinue.Lodge.Component.Room.CheckIn
{
    ...
    public class Dao : Crystal.Activity.Component.Dao
    {
        ...
        protected override BinAff.Core.Data CreateDataObject(DataRow dr, BinAff.Core.Data data)
        {
            ...
            dt.Reservation = Convert.IsDBNull(dr["ReservationId"]) ? null : new Retinue.Lodge.Component.Room.Reservation.Data
            { 
            ...
            dt.Invoice = Convert.IsDBNull(dr["InvoiceId"]) ? null : new Crystal.Accountant.Component.Invoice.Data
            {
        ...
        internal ReturnObject<Boolean> ModifyCheckInStatus(Crystal.Customer.Component.Action.Status.Data status)
        {
