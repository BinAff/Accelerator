...
namespace Retinue.Utility.Facade.Cache
{
    ...
    public class Server : Vanilla.Utility.Facade.Cache.Server
    {
        ...
        private Retinue.Configuration.Rule.Facade.CustomerRuleDto ReadCustomerRule()
        {
            return new Retinue.Configuration.Rule.Facade.RuleServer().ReadCustomerRule().Value;
        }
