...
using RoomRsrvCrys = Retinue.Lodge.Component.Room.Reservation;
...
namespace Retinue.Customer.Component
{
    ...
    public class Dao : Crystal.Customer.Component.Dao
    {
        ...
        private void ReadCustomerRoomReservationLink()
        {
            ...
            (this.Data as Data).RoomReserver = new Retinue.Lodge.Component.Room.Reserver.Data();
        ...
        private void ReadCustomerRoomCheckInLink()
        {
            ...
            DataSet ds = this.ExecuteDataSet();
            (this.Data as Data).Checkin = new Retinue.Lodge.Component.Room.CheckInContainer.Data();
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
