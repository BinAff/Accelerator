...
namespace Retinue.Customer.WinForm
{
    ...
    public partial class CustomerRegister : PresentationLibrary.Form
    {
        ...
        //public CustomerRegister(Retinue.Facade.CustomerManagement.Rule.Dto customerRuleDto)
        //{
        //    InitializeComponent();
        ...
        private void cboCustomer_MouseClick(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            //    ReturnObject<List<Retinue.Facade.LodgeManagement.Reservation.Dto>> reservationList = reservation.GetBooking(dto.Id);
            ...
            //        Retinue.Facade.CustomerManagement.FormDto formDto = new Facade.CustomerManagement.FormDto()
            //        {
            //            ReservationList = new List<LodgeReservationDto>(),
            //        };

            //        foreach (Retinue.Facade.LodgeManagement.Reservation.Dto reservationDto in reservationList.Value)
            //        {
        ...
        private void dgvBooking_CellDoubleClick(object sender, System.Windows.Forms.DataGridViewCellEventArgs e)
        {
            ...
            //{
            //    Retinue.Facade.LodgeManagement.Reservation.Dto reservationDto = this.reservationDtoList[e.RowIndex];
            //    Retinue.Facade.LodgeManagement.Reservation.Dto bookingDto = new Facade.LodgeManagement.Reservation.Dto()
            //    {
            //        Id = reservationDto.Id,
            ...
            //        Advance = reservationDto.Advance,
            //        Customer = (Retinue.Facade.CustomerManagement.Dto)this.cboCustomer.SelectedItem,
