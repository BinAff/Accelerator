...
using CustArtfAuto = Retinue.Customer.Component.Navigator.Artifact;
using RuleAuto = Retinue.Configuration.Rule.Facade;
...
namespace Retinue.Customer.Facade
{
    ...
    public class Server : Vanilla.Form.Facade.Document.Server
    {
        ...
        public override void LoadForm()
        {
            ...
            formDto.RuleDto = (BinAff.Facade.Cache.Server.Current.Cache["Main"] as Retinue.Utility.Facade.Cache.Dto).CustomerRule;
        }
        ...
        //            {
        //                Id = data.Id,
        //                Number = ((LodgeRet.Room.Data)data).Number,
        //                Name = ((LodgeRet.Room.Data)data).Name,
        //                Description = ((LodgeRet.Room.Data)data).Description,
        //                Building = new Lodge.Building.Dto
        //                {
        //                    Id = ((LodgeRet.Room.Data)data).Building.Id,
        //                    Name = ((LodgeRet.Room.Data)data).Building.Name,
        //                    Status = new Table
        //                    {
        //                        Id = ((LodgeRet.Room.Data)data).Building.Status.Id,
        //                        Name = ((LodgeRet.Room.Data)data).Building.Status.Name,
        //                    },

        //                    Type = new Table
        //                    {
        //                        Id = ((LodgeRet.Room.Data)data).Building.Type.Id,
        //                        Name = ((LodgeRet.Room.Data)data).Building.Type.Name,
        //                    }
        //                },
        //                Status = new Table
        //                {
        //                    Id = ((LodgeRet.Room.Data)data).Status.Id,
        //                    Name = ((LodgeRet.Room.Data)data).Status.Name
        //                },
        //                Type = new Table
        //                {
        //                    Id = ((LodgeRet.Room.Data)data).Type.Id,
        //                    Name = ((LodgeRet.Room.Data)data).Type.Name
        //                },
        //                IsAirconditioned = ((LodgeRet.Room.Data)data).IsAirConditioned,
        //                Category = new Table
        //                {
        //                    Id = ((LodgeRet.Room.Data)data).Category.Id,
        //                    Name = ((LodgeRet.Room.Data)data).Category.Name
        //                }
        //            });
        //        }
        //    }
        ...
        {
            return "Retinue.Customer.Component.Navigator.Artifact.Data, Retinue.Customer.Component";
        }
