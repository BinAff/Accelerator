...
namespace Vanilla.Invoice.WinForm.Report
{
    public partial class Quarterly : PresentationLibrary.Form
    {
        ...
        private void LoadData(DateTime date)
        {
            ...
            List<Facade.Dto> invoiceList = report.GetQuarterlyReport(date);
            ...
            if (invoiceList != null && invoiceList.Count > 0)
            {
                ...
                path += @"Vanilla\Source Code\Vanilla\Invoice\Vanilla.Invoice.WinForm\Report\Quarterly.rdlc";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            dto.category = new Vanilla.Report.Facade.Category.Dto { Id = Convert.ToInt64(ReportCategory.Quarterly) };
