...
namespace Vanilla.Configuration.WinForm
{
    ...
    public partial class IdentityProofType : Form
    {

        Facade.IdentityProofType.FormDto formDto;
        ...
        private void IdentityProofType_Load(object sender, EventArgs e)
        {
            this.formDto = new Facade.IdentityProofType.FormDto
            {
                Dto = new Facade.IdentityProofType.Dto(),
                DtoList = new List<Facade.IdentityProofType.Dto>(),
            };
            this.LoadForm();
            this.Clear();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            BinAff.Facade.Library.Server facade = new Facade.IdentityProofType.Server(this.formDto);
            facade.Add();
            this.RebindListBox();
            this.Clear();
        ...
        {
            this.txtName.Text = ((Facade.IdentityProofType.Dto)this.lslList.SelectedItem).Name;
        }
