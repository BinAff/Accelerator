...
namespace Vanilla.Configuration.WinForm
{
    ...
    public partial class Initial : Form
    {
        ...
        Facade.Initial.FormDto formDto;
        ...
        {
            this.formDto = new Facade.Initial.FormDto
            {
                Dto = new Facade.Initial.Dto(),
                DtoList = new List<Facade.Initial.Dto>(),
            };
            this.LoadForm();
            this.Clear();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            BinAff.Facade.Library.Server facade = new Facade.Initial.Server(this.formDto);
            facade.Add();
            this.RebindListBox();
            this.Clear();
        ...
        {
            this.txtName.Text = ((Facade.Initial.Dto)this.lslList.SelectedItem).Name;
        }
