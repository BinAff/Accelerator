...
namespace Vanilla.Configuration.WinForm
{
    ...
    public partial class State : Form
    {
        ...
        {
            this.formDto = new Facade.State.FormDto
            {
                Dto = new Facade.State.Dto(),
                DtoList = new List<Facade.State.Dto>(),
            };
            this.LoadForm();
            this.Clear();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            BinAff.Facade.Library.Server facade = new Facade.State.Server(this.formDto);
            facade.Add();
            this.RebindListBox();
            this.Clear();
        ...
        {
            this.txtName.Text = ((Facade.State.Dto)this.lslList.SelectedItem).Name;
        }
