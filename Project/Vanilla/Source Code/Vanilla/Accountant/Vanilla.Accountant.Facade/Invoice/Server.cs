...
using SellerFac = Vanilla.Accountant.Facade.Invoice.Seller;
using BuyerFac = Vanilla.Accountant.Facade.Invoice.Buyer;
using LineItemFac = Vanilla.Accountant.Facade.Invoice.LineItem;
...
namespace Vanilla.Accountant.Facade.Invoice
{
    ...
    public class Server : DocFac.Server, IInvoice
    {
        ...
        public ReturnObject<Boolean> GenerateInvoice()
        {
            ...
            Dto invoiceDto = (base.FormDto as Invoice.FormDto).Dto as Invoice.Dto;
